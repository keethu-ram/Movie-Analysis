...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://sourabhbajaj.com/}{\Large Keethu Ramalingam}} & Email : \href{mailto:kr439@cornell.edu}{kr439@cornell.edu}\\
  \href{http://sourabhbajaj.com/}{http://www.sourabhbajaj.com} & Mobile : +1-801-577-0462 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Computer Science;  Major GPA: 3.7}{Aug. 2018 -- May. 2022}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {University of Utah, Applied Cognition Lab}{Salt Lake City, UT}
      {Software Developer}{Jun. 2019 - Aug. 2019}
      \resumeItemListStart
